...
import { CheckoutProvider } from "@/contexts/checkout-context.tsx";
...
const VerifyLogin = lazy(() => import("@/pages/verify-login"));
...
const FlashSale = lazy(() => import("@/pages/flash-sale"));
